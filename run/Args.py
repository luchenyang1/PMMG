...
class Arguments():
    def __init__(self):
        ...
        self.DiseaseList = ['P', 'F']
        self.ViewList = ['mutli-modal', 'mutli-view']
        self.SequenceList = ["sag PDW_spair","cor PDW_spair","axi T2w_tse","sag T1w_tse","sag PDW_atse"]
        self.ClassNum = len(self.DiseaseList)*4
        ...
        self.MEAN = 58.09
        self.STDDEV = 49.73
        self.IMG_R = 224 # origin image resolution
        self.Spacing = (0.3, 0.3, 3.3)
        self.SliceNum = 24
        self.Patch_R = 224# patch resolution
        self.Center_Crop = True
        self.ClassDistr = [632, 341, 114, 86, 91, 430, 83, 60, 59] # [total, cls1, cls2...]
        ...
        self.no_corr_mining = True  
        self.separate_final = False
        self.active_class = [1,1]
        self.active_branch = [1,1]
